        ...
        <Container>
          <Row>
            <Col>
              ...
              <h1 className="jumbotron-heading display-4">cueplayer-react</h1>
              <p className="lead">
              ...
              <p>
                <Button
                  outline
                  color="danger"
                  href="https://github.com/cueplayer-react/cueplayer-react"
                >
                  View on Github
                </Button>
      ...
      <Container fluid>
        <Row>
          <Col sm={{ size: 8, offset: 2 }}>
            ...
            <hr />
            <h3>NPM</h3>
            <p>Install cueplayer-react and peer dependencies via NPM</p>
            <pre>
              <PrismCode className="language-bash">
                npm install --save cueplayer-react react react-dom redux
              </PrismCode>
            </pre>
            <h3>Basic example</h3>
            ...
            <pre>
              <PrismCode className="language-jsx">
                @import "~cueplayer-react/styles/scss/cueplayer-react"; // or
                import scss
              </PrismCode>
            </pre>
            <pre>
              <PrismCode className="language-html">
                &lt;link rel="stylesheet" href="/css/cueplayer-react.css" /&gt;
              </PrismCode>
            </pre>
            <pre>
