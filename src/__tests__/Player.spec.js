...
describe('Player', () => {
  ...
  it('should render with "cueplayer-react" class', () => {
    const wrapper = shallow(
      <Player source="https://media.w3.org/2010/05/sintel/trailer_hd.mp4" />
    );
    expect(wrapper.hasClass('cueplayer-react')).toBe(true);
  });
  ...
  it('should set width as "100%", height as "auto"', () => {
    ...
    const containerStyle = container.find('div.cueplayer-react').prop('style');
